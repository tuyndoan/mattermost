...
export const ActionTypes = keyMirror({
    ...
    SET_ADMIN_CONSOLE_TEAM_MANAGEMENT_TABLE_PROPERTIES: null,
    CLEAR_ADMIN_CONSOLE_TEAM_MANAGEMENT_TABLE_PROPERTIES: null,
    SET_ADMIN_CONSOLE_CHANNEL_MANAGEMENT_TABLE_PROPERTIES: null,
    CLEAR_ADMIN_CONSOLE_CHANNEL_MANAGEMENT_TABLE_PROPERTIES: null,
});
